...
export default function ExpensesScreen() {
  ...
  return <Screen title="Expenses" subtitle="Know where your money goes">
    ...
    {expenses.length > 5 ? <TextInput accessibilityLabel="Search expenses" value={query} onChangeText={setQuery} placeholder="Search expenses" placeholderTextColor="#9aa59d" style={styles.search} /> : null}
